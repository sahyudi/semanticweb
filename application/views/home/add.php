...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-5">
            <h2 class="mb-4">Tambah Sertifikat Tanah</h2>
            <form action="<?= site_url('home/add') ?>" method="post">
                <div class="row">

                    <div class="form-group col-md-6">
                        <label>NIB</label>
                        <input type="text" name="nib" class="form-control" value="" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Pemilik</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="kelurahan" class="form-control" value="" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Kecamatan</label>
                        <input type="text" name="kecamatan" class="form-control" value="" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Kota</label>
                        <input type="text" name="kota" class="form-control" value="" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Alamat</label>
                    ...
                    <div class="form-group col-md-6">
                        <label>Luas</label>
                        <input type="number" name="luas" class="form-control" value="" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Status</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="tgl_terbit" class="form-control" value="" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Tanggal Jatuh Tempo</label>
                        <input type="date" name="tgl_jth_tempo" class="form-control" value="" required>
                    </div>
                </div>
